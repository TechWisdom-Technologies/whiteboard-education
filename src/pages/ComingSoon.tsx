    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="intro-surface py-14 md:py-16">
        <div className="w-full max-w-[1640px] mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="rounded-xl overflow-hidden border border-primary-foreground/20 shadow-xl bg-primary-foreground/5">
              <img
      ...
      <div className="flex-1 flex items-center justify-center py-10">
        <div className="text-center space-y-4 max-w-md px-4">
          <div className="h-14 w-14 rounded-xl bg-[#2F4F97]/10 flex items-center justify-center mx-auto">
            <Construction className="h-7 w-7 text-[#2F4F97]" />
          </div>
          <Link to="/">
