    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-6">
        <TabsList className="bg-slate-100 p-1 rounded-xl h-12 inline-flex gap-1">
          <TabsTrigger 
            value="webinars" 
            className="rounded-lg px-4 py-2 text-[13px] font-medium data-[state=active]:bg-white data-[state=active]:text-[#1d283a] data-[state=active]:shadow-sm flex items-center gap-2 transition-all"
          >
