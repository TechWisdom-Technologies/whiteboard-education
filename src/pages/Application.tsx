              ...
              {step === 3 && (
                <div className="space-y-5 animate-fade-in">
                    ...
                    {[
                      ...
                      <div key={field.id} className="p-4 border rounded-lg bg-gray-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <div>
                          ...
                          />
                          <Label htmlFor={field.id} className="cursor-pointer inline-flex items-center justify-center rounded-2xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2">
                  ...
                  <div className="pt-6 space-y-4 border-t mt-8">
                    ...
                    <p className="text-sm text-muted-foreground bg-blue-50 p-3 rounded-2xl text-blue-800">
