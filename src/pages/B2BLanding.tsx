      ...
      <main>
        ...
        <section className="relative bg-gradient-to-b from-[#f8f9fb] to-white min-h-screen pt-0 pb-10 overflow-hidden flex flex-col">
          ...
          <div className="absolute inset-0 z-0 pointer-events-none select-none overflow-hidden">
            ...
            <div className="absolute -top-1/4 -right-1/4 w-[70%] h-[70%] rounded-full bg-[#2F4F97]/[0.08] blur-[100px]" />
            {/* Secondary radial gradient - navy depth from bottom-left */}
            <div className="absolute -bottom-1/4 -left-1/4 w-[60%] h-[60%] rounded-full bg-[#1E293B]/[0.06] blur-[80px]" />
            {/* Tertiary accent - subtle amber center glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40%] h-[40%] rounded-full bg-[#2F4F97]/[0.04] blur-[60px]" />
            {/* Dot grid pattern */}
            <div 
            ...
            <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="hero-lines" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse" patternTransform="rotate(30)">
                  <line x1="0" y1="0" x2="0" y2="60" stroke="#1E293B" strokeWidth="1" />
                </pattern>
              </defs>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="relative">
              <div className="hidden lg:block absolute top-[100px] left-[10%] right-[10%] h-0.5 bg-[#2F4F97]/15 z-0" />
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {registrationSteps.map((s, i) => (
                  <div key={s.step} className="relative z-10 group">
                    <div className="bg-white rounded-xl border border-[#e5e7eb] overflow-hidden hover:shadow-lg hover:border-[#2F4F97]/30 transition-all duration-300">
                      <div className="relative h-44 bg-[#f8f9fb] flex items-center justify-center overflow-hidden">
                        ...
                        <div className="absolute top-3 left-3">
                          <div className="relative inline-block">
                            <div className="absolute -bottom-0.5 -right-0.5 w-7 h-7 bg-[#2F4F97] rounded-xl" />
                            <div className="relative w-7 h-7 bg-[#1E293B] text-white flex items-center justify-center font-bold text-xs rounded-xl z-10">{s.step}</div>
                          </div>
                        </div>
                      </div>
                      <div className="p-5">
          ...
          <div className="container relative z-10 mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-semibold text-white mb-2 leading-tight">
                Ready to Expand Your <br /><span className="text-[#2F4F97]">Malaysia Education Portfolio?</span>
              </h2>
