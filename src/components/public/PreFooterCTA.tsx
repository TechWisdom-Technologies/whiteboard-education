    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center justify-center gap-2 px-3 py-1.5 rounded-xl bg-[#2F4F97]/20 border border-[#2F4F97]/30 text-white mb-6 backdrop-blur-sm">
